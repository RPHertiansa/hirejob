    ...
    <b-modal id="modal-1" hide-header>
      <b-col>
        ...
        <Carousel :navigationEnabled="true" :autoplay="true" :perPage="3">
          <Slide class="p-2">
            <div class="col">
              <img class="img-border" width="120px" height="120px" :src="`http://localhost:3000/${displayModal.image1}`">
            </div>
          </Slide>
          <Slide class="p-2">
            <div class="col">
              <img class="img-border" width="120px" height="120px" :src="`http://localhost:3000/${displayModal.image2}`">
            </div>
          </Slide>
          <Slide class="p-2">
            <div class="col">
              <img class="img-border" width="120px" height="120px" :src="`http://localhost:3000/${displayModal.image3}`">
            </div>
          </Slide>
        </Carousel>
      </b-col>
